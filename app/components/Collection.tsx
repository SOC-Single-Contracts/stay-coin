            ...
            <div className="relative w-90  ">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center">
                    <div className="px-4 pt-20">
                        ...
                        {/* Buttons */}
                        <div className="flex flex-col sm:flex-row gap-3 lg:gap-2 justify-center">
                            <button
                                className=" lg:ml-16 py-4 px-14 rounded-full text-lg font-medium lg:text-xl text-white"
